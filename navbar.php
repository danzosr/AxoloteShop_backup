        ...
        <div class="contenedor contenedor-enlaces-nav">
            ...
            <nav>
                ...
                <tr>
                    ...
                    <td>
                    <?php if(isset($_SESSION['email'])){ ?> <a href="carrito.php"><p style="position:absolute;"><?php echo '('.count($_SESSION['carrito']).')'?></p><img src="img/carrito.svg" width="20px" height="20px"></a>
                    <?php } ?>                    </td>
                    <td>
